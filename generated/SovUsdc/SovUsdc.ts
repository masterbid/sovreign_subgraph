...
export class SovUsdc__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class SovUsdc__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SovUsdc extends ethereum.SmartContract {
  static bind(address: Address): SovUsdc {
    return new SovUsdc("SovUsdc", address);
  }
  ...
  burn(to: Address): SovUsdc__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new SovUsdc__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<SovUsdc__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SovUsdc__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): SovUsdc__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new SovUsdc__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<SovUsdc__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SovUsdc__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
