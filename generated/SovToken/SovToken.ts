...
export class SovToken extends ethereum.SmartContract {
  static bind(address: Address): SovToken {
    return new SovToken("SovToken", address);
  }
  ...
  burn(from: Address, value: BigInt): boolean {
  ...
  try_burn(from: Address, value: BigInt): ethereum.CallResult<boolean> {
  ...
  reignDAO(): Address {
    let result = super.call("reignDAO", "reignDAO():(address)", []);

    return result[0].toAddress();
  }

  try_reignDAO(): ethereum.CallResult<Address> {
    let result = super.tryCall("reignDAO", "reignDAO():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetReignDAOCall extends ethereum.Call {
  get inputs(): SetReignDAOCall__Inputs {
    return new SetReignDAOCall__Inputs(this);
  }

  get outputs(): SetReignDAOCall__Outputs {
    return new SetReignDAOCall__Outputs(this);
  }
}

export class SetReignDAOCall__Inputs {
  _call: SetReignDAOCall;

  constructor(call: SetReignDAOCall) {
    this._call = call;
  }
...
export class SetReignDAOCall__Outputs {
  _call: SetReignDAOCall;
